...
urlpatterns = [
    ...
    path("finance/wo/<int:po_id>/release/", views.retention_release, name="finance_retention_release"),
    ...
    # ---- retention ---------------------------------------------------------
    path("finance/retention/", views.retention, name="finance_retention"),

    # ---- vendor invoices and payments on purchase orders --------------------
    path("finance/invoices/", views.invoices, name="finance_invoices"),
